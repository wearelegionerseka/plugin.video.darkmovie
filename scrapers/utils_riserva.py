...
def recognize_link(link_mirror):
    ...
    #link_mirror = link_mirror.replace("https//", "https://")
    
    if not link_mirror.startswith("http") and not link_mirror.startswith("https"):
        link_mirror = "https:%s" % link_mirror  
    #if not link_mirror.startswith("://")
    #link_mirror = link_mirror.replace("//", "://")  #controllo se arriva un link errato    
